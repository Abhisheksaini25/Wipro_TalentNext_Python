...
'''Q4. Write a program to iterate over a dictionary using for loop and print:
•	Keys alone
•	Values alone
...
#Q5. Write a program to prepare a dictionary where the keys are numbers 
...
#Q6. Write a program to sum all the values in a dictionary.
